...
public abstract class CommonMarker extends SimplePointMarker {
	...
	private int countNearbyMarker = 0;
	private float averageNearby = 0f;
	...
	public int getCountNearbyMarker() {
		return countNearbyMarker;
	}

	public void setCountNearbyMarker(int countNearbyMarker) {
		this.countNearbyMarker = countNearbyMarker;
	}


	public float getAverageNearby() {
		return averageNearby;
	}

	public void setAverageNearby(float averageNearby) {
		this.averageNearby = averageNearby;
	}
}