...
public class LifeExpectancy extends PApplet {
	...
	public void setup() {
		...
		//lifeExpByCountry = loadLifeExpectancyFromCSV("/Users/Bya/Dropbox/Study/coursera/JavaCourses/Course1_OOP/UCSDUnfoldingMaps/data/LifeExpectancyWorldBankModule3.csv");
		lifeExpByCountry = loadLifeExpectancyFromCSV("/Users/01014477/Dropbox/Study/coursera/JavaCourses/Course1_OOP/UCSDUnfoldingMaps/data/LifeExpectancyWorldBankModule3.csv");
		println("Loaded " + lifeExpByCountry.size() + " data entries");
		

		// Load country polygons and adds them as markers
		//countries = GeoJSONReader.loadData(this, "/Users/Bya/Dropbox/Study/coursera/JavaCourses/Course1_OOP/UCSDUnfoldingMaps/data/countries.geo.json");
		countries = GeoJSONReader.loadData(this, "/Users/01014477/Dropbox/Study/coursera/JavaCourses/Course1_OOP/UCSDUnfoldingMaps/data/countries.geo.json");
